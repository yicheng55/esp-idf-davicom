...
#define DM9058_TCSCR (0x31)   // Transmit Check Sum Control Register
#define DM9058_RCSCSR (0x32)  // Receive Check Sum Control Status Register
#define DM9058_SBCR (0x38)    // SPI Bus Control Register
#define DM9058_INTCR (0x39)   // INT Pin Control Register
#define DM9058_PPCSR (0x3D)   // Pause Packet Control Status Register
...
#define DM9058_INTCKCR (0x54) // INT Pin Clock Output Control Register
#define DM9058_MPTRCR (0x55)  // Memory Pointer Control Register
#define DM9058_MLEDCR (0x57)  // More LED Control Register
#define DM9058_MEMSCR (0x59)  // Memory Control Register
#define DM9058_TMEMR (0x5A)   // Transmit Memory Size Register
#define DM9058_MBSR (0x5D)    // Memory BIST Status Register
