...
/** \name Debug messages*/
/**\{*/
// #define PTPD_DBGVV    // 2026-01-08   update - Disable Enable very verbose debug messages
#ifdef PTPD_DBGVV
#define PTPD_DBGV
#define PTPD_DBG
#define PTPD_ERR
...
/* Reduce noisy idle logs without disabling all verbose logs */
#ifndef PTPD_SUPPRESS_IDLE_LOGS
#define PTPD_SUPPRESS_IDLE_LOGS 1
#endif
...
/** \name Offset calculation debug messages*/
/**\{*/
// #define PTPD_DEBUG_PRINTF    // 20250807 update - Enable offset calculation debug messages
#ifdef PTPD_DEBUG_PRINTF
#define PTPD_ERR
#define DBG_PRINTF(...)  { TimeInternal tmpTime; getTime(&tmpTime); printf("(O %d.%09d) ", tmpTime.seconds, tmpTime.nanoseconds); printf(__VA_ARGS__); }
#else
#define DBG_PRINTF(...)
#endif
/** \}*/
...
UInteger32 safeGetRand(UInteger32);
/** \}*/
